...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_SYSNCHRONIZEDTEACHPLANMEDIA_ERROR(false,31103 ,"课程发布时候媒资信息进行同步到索引表的时候出错" ), SEARCHES_TEACHPLANMEDIAPLAN_ERROR(false,31104 ,"搜索ES时候查询教学计划媒资信息时候数据转换出现异常" ), COURSE_MEDIS_VIDEOURLISNULL(false,31105 ,"feign客户端调用加载播放地址失败" );
